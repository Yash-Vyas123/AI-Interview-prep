            ...
            <div className="footer-glass-pane">
                <div className="footer-content">
                    ...
                    <div className="footer-column brand-col">
                        <div className="footer-logo">
                            ...
                            <span className="logo-text">Prepfolio AI</span>
                        </div>
                        ...
                        <div className="social-links">
                            <a href="https://github.com/Yash-Vyas123" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="GitHub">
                                <Github size={20} />
                            </a>
                            <a href="https://www.linkedin.com/in/yash-vyas-" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="LinkedIn">
                                <Linkedin size={20} />
                            </a>
                            <a href="https://x.com/yash_vyas830" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Twitter">
                                <Twitter size={20} />
                            </a>
                        </div>
                    </div>
                ...
                <div className="footer-bottom">
                    <p className="copyright">
                        &copy; {new Date().getFullYear()} Prepfolio AI. Built with <Heart size={14} className="heart-icon" fill="currentColor" /> by Yash Vyas.
                    </p>
